    ...
    for row in query:
        ...
        untersuchung = ABWASSER.untersuchung(
            ...
            **maintenance_event_common(row),
            ...
            bispunktbezeichnung=null_to_emptystr(row.to_point_identifier),
            ...
            videonummer=null_to_emptystr(row.videonumber),
            vonpunktbezeichnung=null_to_emptystr(row.from_point_identifier),
