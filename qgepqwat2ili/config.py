...
ILI2PG = os.path.join(BASE, "bin", "ili2pg-5.1.0-bindist", "ili2pg-5.1.0.jar")
ILIVALIDATOR = os.path.join(BASE, "bin", "ilivalidator-1.14.1-bindist", "ilivalidator-1.14.1.jar")
