...
#5.7.2022 hack
#import sys
#sys.path.append(r"C:\Users\Stefan\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\qgepplugin\qgepqwat2ili\qgepqwat2ili")

BASE = os.path.dirname(__file__)

#print(BASE)
#neu 28.6.2022 sb
#from .gui.gui_export import GuiExport

from .gui.gui_export import selected_model
...
if gui_export.selected_version == "VSA_KEK_2019_LV95":
# if exportmodell == "VSA_KEK_2019_LV95":
#['VSA_KEK_2019_LV95']
...
elif exportmodell == "SIA405_ABWASSER_2015_LV95":
...
#elif gui_export.comboBox_modelselection.currentText() == "DSS_2015_LV95":
elif exportmodell == "DSS_2015_LV95":
# ['DSS_2015_LV95']
    ABWASSER_SCHEMA = "pg2ili_dss"
    DSS_ILI_MODEL = os.path.join(ILI_FOLDER, "VSA_DSS_2015_2_d-20200330.ili")
    ABWASSER_ILI_MODEL = "DSS_2015_LV95"

else:
    print("Unknown model - check config.py")
    exit(1)

#27.6.2022 sb additional models 
# KEK_SCHEMA = "pg2ili_kek"
# KEK_ILI_MODEL = os.path.join(ILI_FOLDER, "VSA_KEK_2019_2_d_LV95-20210120.ili")
# KEK_ILI_MODEL_NAME = "VSA_KEK_2019_LV95"

# SIA405ABWASSER_SCHEMA = "pg2ili_sia405abwasser"
# SIA405ABWASSER_ILI_MODEL = os.path.join(ILI_FOLDER, "SIA405_Abwasser_2015_2_d-20180417.ili")
# SIA405ABWASSER_ILI_MODEL_NAME = "SIA405_ABWASSER_2015_LV95"

# DSS_SCHEMA = "pg2ili_dss"
# DSS_ILI_MODEL = os.path.join(ILI_FOLDER, "VSA_DSS_2015_2_d-20200330.ili")
# DSS_ILI_MODEL_NAME = "DSS_2015_LV95"
