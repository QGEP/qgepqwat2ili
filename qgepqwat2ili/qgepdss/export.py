    ...
    if filtered:
        query = (
            query.join(
                ...
                re_maintenance_event_wastewater_structure.fk_maintenance_event
                == fk_maintenance_event.obj_id,
            )
            .join(
                QGEP.wastewater_structure,
                re_maintenance_event_wastewater_structure.fk_wastewater_structure
